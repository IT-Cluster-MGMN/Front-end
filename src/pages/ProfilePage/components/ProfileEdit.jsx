...
const ProfileEdit = ({ user, onChange }) => {
  ...
  return (
    <div
      className="flex justify-end items-start h-screen stroke-[#000000] bg-gray-400 border-black shadow-inner rounded-lg p-8 "
      style={{
        width: "950px",
        height: "680px",
        borderRadius: "120px",
    ...
    >
      ...
      <div
        className="flex flex-col font-sans items-center stroke-[#000000] w-[400px] h-[535px] bg-white border border-black rounded-[32px] shadow-inner rgba(0, 0, 0, 0.5)"
        style={{
          position: "absolute",
          border: "2px solid gray",
          bottom: "25%",
      ...
      >
        <img
          className="rounded-full opacity-90% w-45 h-40 mx-auto"
          src={user.photo}
          alt="User"
        />
        ...
        <button
          ...
          className="add-to-cart absolute bottom-[3%]"
        >
          Save
        </button>
      </div>
      <div
        className="flex flex-col w-[320px] h-[300px] items-center w-1/4 bg-white border border-black rounded-[32px]  p-2 shadow"
        style={{
          position: "absolute",
          border: "2px solid gray",
          bottom: "50%",
      ...
      >
        ...
        <button className="add-to-cart absolute bottom-[3%] w-[100px] h-[35px] text-center">
          Save
        </button>
      </div>
      <div
        className="self-end w-[300px] h-[280px] bg-white  border-black rounded-[32px] p-4 shadow"
        style={{
          position: "absolute",
          border: "2px solid gray",
          bottom: "15%",
      ...
      >
        <div className=" font-sans no-underline text-[24px]">
          ...
          <button className="add-to-cart absolute left-[15%] bottom-[25%]">
            Save
          </button>
        </div>
      </div>
