...
//   const [patronymic, isValidPatronymic, setPatronymic] = useRegexValidation(user.additional, nameRegex);
...
//   const [birthDate, isValidBirthDate, setBirthDate] = useRegexValidation(user.date_birth, nameRegex);
// >>>>>>> e0b28bf (profile-edit)
...
//         <InputField placeholder={birthDate} onChange={(e) => handleInputChange(e, setBirthDate)} className='absolute left-[400%] flex-nowrap w-1/2 whitespace-nowrap' label="Birth date"/>
//       {/*TODO: create generic button component*/}
//       </form>
//
//       <h1 className=' flex  flex-col absolute left-[25%] bottom-[50%]'>Contacts</h1>
